...
export default {
  ...
  methods: {
    processForm: function() {
      const getFedCampsites = axios.get(`https://www.recreation.gov/api/search?q=${this.currentTrip.origin}&exact=false&fq=campsite_type_of_use%3AOvernight&fq=entity_type%3Acampground&start=0`);
